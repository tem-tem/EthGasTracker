...
struct AverageEntry: Codable {
    ...
    // Custom decoding to handle both String and Double for numeric fields
    init(from decoder: Decoder) throws {
        ...
        minuteOfDay = try AverageEntry.decodeAsInt(container, forKey: .minuteOfDay)
    ...
    // Helper function to decode either an Int or String and convert it to Int
